...
public class LineItemDAOImpl implements LineItemDAO {
    private static final String getLineItemsByOrderIdSQL = "SELECT " +
            ...
            "FROM LINEITEM " +
            "WHERE ORDERID = ?";
    private static final String insertLineItemSQL = " INSERT INTO LINEITEM " +
    ...
    public List<LineItem> getLineItemsByOrderId(int orderId) {
        ...
        try {
            ...
            PreparedStatement preparedStatement = connection.prepareStatement(getLineItemsByOrderIdSQL);
    ...
    public void insertLineItem(LineItem lineItem) {
        try {
            Connection connection = DBUtil.getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement(insertLineItemSQL);
